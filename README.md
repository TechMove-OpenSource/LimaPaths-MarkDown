...
- **Color Scheme**: La paleta de colores se centra en tonos verdes y blanco, evocando naturaleza y salud, alineada con la temática de seguimiento de rutas al aire libre.
- **Tipografía**: Se usa una fuente moderna y limpia como **Poppins**, que combina bien con el enfoque minimalista de la página, asegurando la legibilidad tanto en dispositivos móviles como de escritorio.
- **Iconografía**: Los iconos son claros y vectoriales, orientados a representar actividades como correr, andar en bicicleta o caminar, manteniendo un estilo visual consistente y ligero.

# Propuesta de Interacción

- **Navegación**: Se propone un menú fijo en la parte superior, que se adapta en dispositivos móviles a un botón de menú desplegable. Este menú permite un acceso rápido a las secciones clave: “Inicio”, “Características”, “Descargar” y “Contacto”.
- **Scroll Animado**: La página utiliza un efecto de scroll suave, lo que mejora la experiencia visual cuando el usuario navega hacia abajo para descubrir más información.

# Wireframe

- **Header**: Incluye el logotipo a la izquierda y un menú de navegación a la derecha. Un botón CTA “Descargar la App” está siempre visible en la esquina derecha.
- **Sección Principal**: Una imagen de fondo de pantalla completa que representa una actividad al aire libre, como una ruta en la naturaleza. El texto principal describe la funcionalidad de la aplicación, acompañado de botones de descarga directa.
- **Características Clave**: Esta sección presenta los beneficios de usar TrackMyRoute con iconos representativos y breves descripciones bajo cada uno.
- **Pie de Página**: Incluye enlaces de contacto, redes sociales y un formulario para suscribirse a novedades de la aplicación.

# Aplicaciones y Microinteracciones
- **Hover Animations**: Los botones y enlaces responden con efectos de cambio de color o ligeros agrandamientos cuando el usuario pasa el cursor sobre ellos.
- **Load Animations**: Las secciones clave como “Características” aparecen con una ligera animación de entrada al desplazarse hacia abajo, manteniendo al usuario comprometido con la página.
